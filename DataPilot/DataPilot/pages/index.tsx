...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-yellow-50 to-amber-50 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 w-80 h-80 bg-gradient-to-br from-yellow-200/40 to-yellow-300/20 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-br from-amber-200/30 to-yellow-200/20 rounded-full blur-2xl"></div>
        <div className="absolute top-1/2 left-20 w-64 h-64 bg-gradient-to-br from-yellow-300/20 to-amber-200/10 rounded-full blur-xl"></div>
        <div className="absolute bottom-10 left-1/3 w-48 h-48 bg-gradient-to-br from-yellow-200/30 to-yellow-100/20 rounded-full blur-lg"></div>
      </div>
      ...
      <div className="max-w-4xl w-full relative z-10">
        ...
        <motion.div
          ...
          className="rounded-3xl bg-white/90 backdrop-blur-sm shadow-2xl border border-white/50 p-12 text-center relative overflow-hidden"
        >
          {/* Browser-like header */}
          ...
          <div className="mt-8">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={startTest}
                className="bg-yellow-300 hover:bg-yellow-400 text-slate-700 font-bold px-12 py-4 rounded-2xl transition-all duration-200 text-xl shadow-lg"
              >
                Start Assessment
              </motion.button>
            </motion.div>
